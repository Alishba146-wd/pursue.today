export default function ServicesGridSection() {
  return (
    <section className="py-12 md:py-20" style={{ background: 'linear-gradient(to right, #b8ddf0 0%, #c4e3f3 25%, #e4f1fa 40%, #ffffff 50%, #ffffff 70%, #e4f1fa 80%, #c4e3f3 90%, #b8ddf0 100%)' }}>
